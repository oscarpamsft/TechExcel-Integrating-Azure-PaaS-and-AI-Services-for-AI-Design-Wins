...
[KernelFunction]
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate(
        [Description("The ID of the hotel")] int hotelId, [Description("DateTime")] DateTime dt)
    {
...
[KernelFunction]
    ...
    /// <summary>
    /// Get bookings that with more than one hotel room.
    /// 
[KernelFunction]
    [Description("Get bookings that with more than one hotel room.")]
